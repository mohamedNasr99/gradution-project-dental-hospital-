    ...
    public partial class initially : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Admins", x => x.SSN);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SSN = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AdminSSN = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClinicId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professors_Admins_AdminSSN",
                        column: x => x.AdminSSN,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Admins_AdminSSN",
                        column: x => x.AdminSSN,
                        principalTable: "Admins",
                        principalColumn: "SSN",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DentalHistory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalReports_Students_StudentSSN",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MedicalReportId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalReports_StudentSSN",
                table: "MedicalReports",
                column: "StudentSSN");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professors_AdminSSN",
                table: "Professors",
                column: "AdminSSN");

            migrationBuilder.CreateIndex(
                name: "IX_Professors_ClinicId",
                table: "Professors",
                column: "ClinicId");
